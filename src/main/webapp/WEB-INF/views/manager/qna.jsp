...
<%--                 <th scope="row">${qna.qnaCode}</th> --%>
          ...
          <div class="d-grid gap-2 col-2 mx-auto">
	          <nav aria-label="Page navigation example">
				  <ul class="pagination">
				  	<c:if test="${nowPage!=1}">
						<li class="page-item"><a class="page-link" href="<c:url value='/manager/qna?nowPage=1' /> ">처음</a></li>
						<li class="page-item"><a class="page-link" href="<c:url value='/manager/qna?nowPage=${nowPage - 1}' /> ">이전</a></li>
					</c:if>
					...
					<c:if test="${nowPage!=totalPage}">
						<li class="page-item"><a class="page-link" href="<c:url value='/manager/qna?nowPage=${nowPage + 1}' /> ">다음</a></li>
						<li class="page-item"><a class="page-link" href="<c:url value='/manager/qna?nowPage=${totalPage}' /> ">마지막</a></li>
					</c:if>

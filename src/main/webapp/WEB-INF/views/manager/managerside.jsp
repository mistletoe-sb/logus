...
<html>
	...
	<body>
		<ul class="list-group">
		  ...
		  <li class="list-group-item list-group-item-warning"><a href="<c:url value='/manager/memberlist'/>">회원 관리</a></li>
		  <c:if test="${sessionScope.sessionManagerLevel == 0}">
		  	<li class="list-group-item list-group-item-warning"><a href="<c:url value='/manager/managerlist'/>">관리자 관리(마스터)</a></li>
		  </c:if>
		  <li class="list-group-item list-group-item-warning"><a href="<c:url value='/manager/statistics'/>">통계</a></li>
		  <li class="list-group-item list-group-item-warning"><a href="<c:url value='/manager/managerlogout'/>">관리자 로그아웃</a></li>
		</ul>

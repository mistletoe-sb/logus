...
public interface ITagDAO {
	public void insertTag(TagVO vo);					// 태그 추가
	public int updateTag(TagVO vo);						// 태그 수정
	//public int deleteTag(int tagCode);				// 태그 삭제
	public int deleteTag(List<Integer> tagCode);		// 태그 여러 개 삭제
	public int deleteTagALL(int tagCategory, int foreignKeyCode, int tagCount);	// 해당 게시물의 태그 전체 삭제
